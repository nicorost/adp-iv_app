...
score_kat_diag <- function(antworten, alg) {
  ...
  output <- data.frame(
    ...
    `erfuellte Kriterien/Items` = c(paste(paranoid$Item[paranoid$erfuellt == 1], collapse = ", "),
                                    paste(schizoid$Item[schizoid$erfuellt == 1], collapse = ", "),
                                    paste(schizotypisch$Item[schizotypisch$erfuellt == 1], collapse = ", "),
                                    paste(vermeidend$Item[vermeidend$erfuellt == 1], collapse = ", "),
                                    paste(dependent$Item[dependent$erfuellt == 1], collapse = ", "),
                                    paste(zwanghaft$Item[zwanghaft$erfuellt == 1], collapse = ", "),
                                    paste(antisozial$Item[antisozial$erfuellt == 1], collapse = ", "),
                                    paste(borderline$Item[borderline$erfuellt == 1], collapse = ", "),
                                    paste(histrionisch$Item[histrionisch$erfuellt == 1], collapse = ", "),
                                    paste(narzisstisch$Item[narzisstisch$erfuellt == 1], collapse = ", "),
                                    paste(nnb_depressiv$Item[nnb_depressiv$erfuellt == 1], collapse = ", "),
                                    paste(nnb_passiv$Item[nnb_passiv$erfuellt == 1], collapse = ", ")),
